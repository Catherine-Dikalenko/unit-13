...
function f5(arr, block) {
    ...
    block.innerHTML = out;// тут вывод в блок block
}
...
document.querySelector('.b-5').onclick = () => {
    ...
    f5(a5, document.querySelector('.out-5'));
}
...
function f6() {
    ...
    f5(a6, document.querySelector('.out-6'));
}
...
function f11() {
    ...
    f5(a11, document.querySelector('.out-11'));
}
...
function f12() {
    ...
    f5(a12, document.querySelector('.out-12'));
}
...
function f19() {
    ...
    for (let color in a19) {
        ...
        for (let i = 0; i < stations.length; i++) {
            if (stations[i].toLowerCase() === i19.toLowerCase()) {
                out = color;
                break;
            }
        }
